...
public class CmdMKD extends FtpCmd implements Runnable {
	...
	public CmdMKD(SessionContext sessionContext, String input) {
	...
	public void run() {
		...
		mainblock: {
			...
			toCreate = inputPathToChrootedFile(sessionContext.getWorkingDir(), param);
		...
		if(errString != null) {
			...
			sessionContext.writeString("250 Directory created\r\n");
		}
	}
