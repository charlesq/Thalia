...
abstract public class CmdAbstractStore extends FtpCmd {
	...
	public CmdAbstractStore(SessionContext sessionContext) {
...
//		myLog.l(Log.DEBUG, "STOR original priority: " + origPriority);
		storing: {
			...
			sessionContext.writeString("150 Data socket ready\r\n");
...
//			myLog.l(Log.DEBUG, "New STOR prio: " + newPriority);
			...
			while(true) {
				...
				switch(numRead = sessionContext.receiveFromDataSocket(buffer)) {
				case -1:
...
//			}
		...
		if(errString != null) {
			...
			sessionContext.writeString("226 Transmission complete\r\n");
